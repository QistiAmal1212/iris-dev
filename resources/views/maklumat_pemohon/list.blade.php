...
<tr>
	...
	<td><div class="btn-group btn-group-sm d-flex justify-content-center" role="group" aria-label="Action"><a class='btn btn-xs btn-default' onclick="searchCandidate('{{$user->no_kp_baru}}')"> <i class="fas fa-eye text-primary"></i></div> </td>
</tr>
@endforeach
</tbody>
</table>
