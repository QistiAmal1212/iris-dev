...
<div class="accordion" id="accordion_personal_details">
    {{-- Peribadi --}}
    <div class="accordion-item">
        <h2 class="accordion-header" id="heading_personal_info">
            <button class="accordion-button fw-bolder text-primary" type="button" data-bs-toggle="collapse" data-bs-target="#personal_info" aria-expanded="true" aria-controls="personal_info">
                Peribadi
            </button>
        </h2>
        <div id="personal_info" class="accordion-collapse collapse show" aria-labelledby="heading_personal_info" data-bs-parent="#accordion_personal_details">
            <div class="accordion-body">

                <div class="d-flex justify-content-end align-items-center mb-1" id="update_personal" style="display:none">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4 mb-1">
                                ...
                                <select class="select2 form-control" name="race" id="race" disabled>
                                    <option value="" hidden>Keturunan</option>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6 mb-1">
                                ...
                                <select class="select2 form-control" name="marital_status" id="marital_status" disabled>
                                    <option value="" hidden>Taraf Perkahwinan</option>
    ...
    {{-- Peribadi HISTORY --}}
    <div class="accordion-item">
        <h2 class="accordion-header" id="heading_history_personal">
            <button class="accordion-button collapsed fw-bolder text-primary" type="button" data-bs-toggle="collapse" data-bs-target="#history_personal" aria-expanded="false" aria-controls="history_personal">
                Jejak Audit [Peribadi]
            </button>
        </h2>
        <div id="history_personal" class="accordion-collapse collapse" aria-labelledby="heading_history_personal" data-bs-parent="#accordion_personal_details">
            <div class="accordion-body">
                <div class="row">
                    <div class="col-sm-6 col-md-6 col-lg-6 mb-1">
