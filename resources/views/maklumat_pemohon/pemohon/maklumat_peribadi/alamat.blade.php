<div class="bs-stepper vertical vertical-wizard">
    ...
    <div class="bs-stepper-content">
        ...
        <div id="alamat-surat-info" class="content parent-tab" role="tabpanel" aria-labelledby="alamat-surat-info-trigger">
            ...
            <form id="" action="" method="POST" data-refreshFunctionName="reloadTimeline" data-refreshFunctionNameIfSuccess="reloadAlamatTetap" data-reloadPage="false">
                @csrf
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 mb-1">
                        <label class="form-label">Alamat</label>
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4 mb-1">
                        <label class="form-label">Poskod</label>
                        <input type="text" class="form-control" value="" name="" id="" maxlength="5" oninput=""  disabled>
                    </div>

                    <div class="col-sm-4 col-md-4 col-lg-4 mb-1">
                        <label class="form-label">Bandar</label>
                        <input type="text" class="form-control" value="" name="city" id="city" oninput="" disabled>
                    </div>
                ...
                <div id="" style="display:none">
                    <button type="button" id="btnEditAamatTetap" hidden onclick="generalFormSubmit(this);"></button>
                    <div class="d-flex justify-content-end align-items-center my-1">
