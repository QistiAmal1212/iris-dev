...
<div class="main-menu menu-fixed {{ $configData['theme'] === 'dark' || $configData['theme'] === 'semi-dark' ? 'menu-dark' : 'menu-light' }} menu-accordion menu-shadow" data-scroll-to-active="true">
            ...
            <li class="nav-item me-auto">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <span class="brand-logo">
                        <img src="{{asset($logo_header)}}" class="brand-image img-circle elevation-3" style="opacity: .8">
                    ...
                    <h2 class="brand-text">{{ $system_name }}</h2>
                </a>
            </li>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            {{-- <li class="nav-item {{ in_array(request()->route()->getName(), ['inbox']) ? 'menu-open' : '' }}">
            <a href="{{ route('inbox') }}" class="d-flex align-items-center">
                <i data-feather="mail"></i>
                <span class="menu-title text-truncate">{{__('msg.inbox')}} </span>
            </a>
            </li> --}}
