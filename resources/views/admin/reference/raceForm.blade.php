<div class="modal fade text-start" id="raceFormModal" tabindex="-1" aria-labelledby="title-role" aria-hidden="true" data-bs-backdrop="false" style="background:rgba(0,0,0,0.5);">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.reference.race.store') }}" method="POST" id="raceForm" data-reloadPage="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label class="form-label" for="name">Keturunan
                                    <span class="text text-danger">*</span>
                                </label>
                                <div class="input-group">
