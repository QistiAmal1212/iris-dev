...
<script>
    ...
    function toggleActive(matriculationSubjectId) {
            var url = "{{ route('admin.reference.matriculation-subject.toggleActive', ':replaceThis') }}"
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success) {
                        ...
                        var button = document.querySelector('[data-id="' + matriculationSubjectId + '"]');
