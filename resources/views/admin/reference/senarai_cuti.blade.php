                ...
                <div class="row align-items-center">
                    <div class="col-sm-4 col-md-4 col-lg-4">
                        ...
                        <select name="activity_type_id" id="activity_type_id" class="select2 form-control">
                            ...
                            <option value="{{ $kat->kod }}">{{ $kat->kod }} - {{ $kat->diskripsi }} </option>
                            @endforeach
                        </select>
                    </div>
...
@section('script')
    <script>
        ...
        table = $('#table-senaraicuti').DataTable().destroy();

        table = $('#table-senaraicuti').DataTable({
            orderCellsTop: true,
            colReorder: false,
            pageLength: 25,
            processing: true,
        ...
        senaraicutiForm = function(id = null) {
            ...
            if (id === null) {
                ...
                $('#senaraicutiForm select[name="kategori"]').val("").trigger('change');
        ...
        function deleteItem(senaraicutiId){
        var url = "{{ route('admin.reference.senaraicuti.delete', ':replaceThis') }}"
        url = url.replace(':replaceThis', senaraicutiId);
