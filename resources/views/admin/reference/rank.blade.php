...
@section('script')
    <script>
        ...
        rankForm = function(id = null) {
            var rankFormModal;
            rankFormModal = new bootstrap.Modal(document.getElementById('rankFormModal'), {
                keyboard: false
            });
        ...
        function toggleActive(rankId) {
            var url = "{{ route('admin.reference.rank.toggleActive', ':replaceThis') }}"
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success) {
                        ...
                        var button = document.querySelector('[data-id="' + rankId + '"]');
