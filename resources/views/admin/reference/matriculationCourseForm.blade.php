<div class="modal fade text-start" id="matriculationCourseFormModal" tabindex="-1" aria-labelledby="title-role" aria-hidden="true" data-bs-backdrop="false" style="background:rgba(0,0,0,0.5);">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.reference.matriculation-course.store') }}" method="POST" id="matriculationCourseForm" data-reloadPage="true">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
