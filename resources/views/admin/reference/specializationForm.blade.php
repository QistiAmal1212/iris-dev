<div class="modal fade text-start" id="specializationFormModal" tabindex="-1" aria-labelledby="title-role" aria-hidden="true" data-bs-backdrop="false">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.reference.specialization.store') }}" method="POST" id="specializationForm" data-reloadPage="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label class="form-label" for="name">Nama Pengkhususan <span class="text text-danger">*</span> </label>
                                <div class="input-group">
