            ...
            <div class="modal-body">
                <form action="{{ route('admin.reference.daerah.store') }}" method="POST" id="daerahForm" data-reloadPage="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-label" for="kod_rujukan_bahagian">Bahagian
                                    <span class="text text-danger">*</span>
                                </label>
                                <div class="input-group">
                                    <select id="kod_rujukan_bahagian" name="kod_rujukan_bahagian" class="form-control" required>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-label" for="kod_rujukan_negeri">Negeri
                                    <span class="text text-danger">*</span>
                                </label>
                                <div class="input-group">
                                    <select id="kod_rujukan_negeri" name="kod_rujukan_negeri" class="form-control" required>
                                        <option value="">Sila Pilih:-</option>
