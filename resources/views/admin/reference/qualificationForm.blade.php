<div class="modal fade text-start" id="qualificationFormModal" tabindex="-1" aria-labelledby="title-role" aria-hidden="true" data-bs-backdrop="false">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="title-role">Tambah Kelulusan</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('admin.reference.qualification.store') }}" method="POST" id="qualificationForm" data-reloadPage="true">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label class="form-label" for="name">Nama Kelulusan <span class="text text-danger">*</span> </label>
                                <div class="input-group">
