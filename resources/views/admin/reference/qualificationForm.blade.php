<div class="modal fade text-start" id="qualificationFormModal" tabindex="-1" aria-labelledby="title-role" aria-hidden="true" data-bs-backdrop="false" style="background:rgba(0,0,0,0.5);">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.reference.qualification.store') }}" method="POST" id="qualificationForm" data-reloadPage="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label class="form-label" for="name">Nama Kelulusan
                                    <span class="text text-danger">*</span>
                                </label>
                                <div class="input-group">
