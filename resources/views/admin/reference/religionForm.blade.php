<div class="modal fade text-start" id="religionFormModal" tabindex="-1" aria-labelledby="title-role" aria-hidden="true" data-bs-backdrop="false">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.reference.religion.store') }}" method="POST" id="religionForm" data-reloadPage="true">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-6">
                            <div class="form-group">
                                <label class="form-label" for="name">Agama <span class="text text-danger">*</span> </label>
                                <div class="input-group">
