<div class="modal fade text-start" id="institutionFormModal" tabindex="-1" aria-labelledby="title-role" aria-hidden="true" data-bs-backdrop="false">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('admin.reference.institution.store') }}" method="POST" id="institutionFormModal" data-reloadPage="true">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label class="form-label" for="name">Nama Institusi <span class="text text-danger">*</span> </label>
                                <div class="input-group">
