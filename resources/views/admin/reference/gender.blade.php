...
<script>
    ...
    genderForm = function(id = null){
        ...
        if(id === null){
            ...
            $('#genderForm input[name="code"]').prop('readonly', false);
    ...
    function toggleActive(genderId) {
            var url = "{{ route('admin.reference.gender.toggleActive', ':replaceThis') }}"
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success) {
                        ...
                        var button = document.querySelector('[data-id="' + genderId + '"]');
