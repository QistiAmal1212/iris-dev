<div class="card-header bg-transparent">
    <h4 class="card-title w-100">View Faq</h4>
</div>
    ...
    <div class="col-md-12">
        <form action="{{ route('faq.update', $faq->id) }}" method="POST" class="form-horizontal" autocomplete="off">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" disabled class="form-control" id="inputQuestion" placeholder="Question" value="{{ $faq->question }}" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="inputAnswer" class="col-sm-2 col-form-label">Answer <b class="text-danger"></b></label>
                <div class="col-sm-10">
                    <input type="text" disabled class="form-control" id="inputAnswer" placeholder="Answer" value="{{ $faq->answer }}" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="inputFaqType" class="col-sm-2 col-form-label">Faq Type <b class="text-danger"></b></label>
                <div class="col-sm-10">
                    <select class="custom-select rounded-0 text" id="inputFaqType" disabled required>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select class="custom-select rounded-0 text" id="inputLocale" disabled required>
                        <option value="">Please Select</option>
