    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body px-sm-2 mx-50">
                <h1 class="text-center mb-1" id="addNewCardTitle">User Form</h1>
                ...
                <form id="userFormModal" action="" method="POST" data-reloadPage="true" name="FormUserModal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="form-label" for="role_description">IC <span class="text text-danger">*</span> </label>
                                    <div class="input-group">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="form-group">
                                    <label class="form-label" for="role_description">Email <span class="text text-danger">*</span> </label>
                                    <div class="input-group">
                            ...
                            <div class="col-md-6 col-12 mb-1">
                                ...
                                <input
                                    ...
                                    autofocus
                                />
                                <span class="input-group-text cursor-pointer" name="the_eye_2"><i data-feather="eye"></i></span>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12 mb-1">
                                ...
                                <div class="input-group input-group-merge form-password-toggle">
                                    ...
                                    tabindex="2"
                                    />
                                    <span class="input-group-text cursor-pointer" name="the_eye"><i data-feather="eye"></i></span>
                                </div>
                            </div>
