            ...
            <div class="card-body">
                <form action="{{ route('user.update', $user) }}" method="POST" class="form-horizontal" autocomplete="off">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="password" name="password" class="form-control" id="inputPassword" placeholder="Password" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputIsActive" class="col-sm-2 col-form-label">Active</label>
                        <div class="col-sm-10">
                            <select name="is_active" class="form-control" id="inputIsActive" required disabled>
                                <option value=""></option>
