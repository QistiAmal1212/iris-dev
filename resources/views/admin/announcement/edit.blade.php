<div class="card-header bg-transparent">
    <h4 class="card-title w-100">Edit Announcement</h4>
</div>
    ...
    <div class="col-md-12">
        <form action="{{ route('announcement.update', $announcement->id) }}" method="POST" class="form-horizontal" autocomplete="off">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="title" class="form-control" id="inputTitle" placeholder="Title" value="{{ $announcement->title }}" required>
                </div>
            </div>
            <div class="form-group row">
                <label for="inputDescription" class="col-sm-2 col-form-label">Description <b class="text-danger">*</b></label>
                <div class="col-sm-10">
                    <textarea name="description" class="form-control" rows="3" placeholder="Description" required>{{ $announcement->description }}</textarea>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                <div class="col-sm-6">
                    ...
                    <div class="input-group date" id="inputDateStart" data-target-input="nearest">
                        <input name="date_start" type="text" class="form-control datetimepicker-input" data-target="#inputDateStart" value="{{ \Carbon\Carbon::parse($announcement->date_start)->format('d/m/Y') }}" required />
                ...
                <div class="col-sm-6">
                    ...
                    <div class="input-group date" id="inputDateEnd" data-target-input="nearest">
                        <input name="date_end" type="text" class="form-control datetimepicker-input" data-target="#inputDateEnd" value="{{ \Carbon\Carbon::parse($announcement->date_end)->format('d/m/Y') }}" required />
