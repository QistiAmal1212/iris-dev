<div class="card-header bg-transparent">
    <h4 class="card-title w-100">Edit Holiday</h4>
</div>
    ...
    <div class="col-md-12">
        <form action="{{ route('holiday.update', $holiday->id) }}" method="POST" class="form-horizontal" autocomplete="off">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input type="text" name="name" class="form-control" id="inputName" placeholder="Name" required value="{{ $holiday->name }}">
                </div>
            </div>
            <div class="form-group row">
                <label for="inputMessage" class="col-sm-2 col-form-label">Message <b class="text-danger">*</b></label>
                <div class="col-sm-10">
                    <textarea name="message" class="form-control" rows="3" placeholder="Message" required>{!! $holiday->message !!}</textarea>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="row col-sm-10 pt-2">
                  <div class="custom-control custom-switch mr-5">
                    <input name="is_active_emel" type="checkbox" class="custom-control-input" id="inputIsActiveEmel" value="1" {{ $holiday->is_active_emel ? 'checked' : '' }}>
                    <label class="custom-control-label" for="inputIsActiveEmel">Email</label>
                  </div>
                  <div class="custom-control custom-switch">
                    <input name="is_active_system" type="checkbox" class="custom-control-input" id="inputIsActiveSystem" value="1" {{ $holiday->is_active_system ? 'checked' : '' }}>
