...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ url('/admin/notify') }}">Notify</a></li>
    <li class="breadcrumb-item active">Create Notify</li>
@endsection

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('notify.store') }}" method="POST" class="form-horizontal" autocomplete="off">
                @csrf
