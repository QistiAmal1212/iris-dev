...
return new class extends Migration
{
    ...
    {
        Schema::table('calon_pengalaman_sej', function (Blueprint $table) {
            $table->string('created_by')->change();
            $table->string('updated_by')->change();
            $table->renameColumn('no_pengenalan', 'cal_no_pengenalan');
            $table->renameColumn('kod_ruj_pekerjaan', 'pek_kod');
            $table->renameColumn('kod_ruj_gred_gaji', 'ggh_kod');
            $table->renameColumn('kod_ruj_tingkatan_jkk', 'tj_kod');
            $table->renameColumn('tarikh_lantik', 'tarikh_lantik1');
            $table->renameColumn('ruj_kem_jabatan', 'kj_kod');
    ...
    public function down(): void
    {
        Schema::table('calon_pengalaman_sej', function (Blueprint $table) {
            ...
            $table->renameColumn('pek_kod', 'kod_ruj_pekerjaan');
            $table->renameColumn('ggh_kod', 'kod_ruj_gred_gaji');
            $table->renameColumn('tj_kod', 'kod_ruj_tingkatan_jkk');
            $table->renameColumn('tarikh_lantik1', 'tarikh_lantik');
            $table->renameColumn('kj_kod', 'ruj_kem_jabatan');
