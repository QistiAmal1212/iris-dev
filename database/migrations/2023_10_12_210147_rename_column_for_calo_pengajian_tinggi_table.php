...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('calon_pengajian_tinggi', function (Blueprint $table) {
            ...
            $table->renameColumn('kod_ruj_institusi', 'ins_kod');
            $table->renameColumn('kod_ruj_kelayakan', 'kel_kod');
            $table->renameColumn('kod_ruj_pengkhususan', 'pen_kod');
    ...
    public function down(): void
    {
        Schema::table('calon_pengajian_tinggi', function (Blueprint $table) {
            ...
            $table->renameColumn('ins_kod', 'kod_ruj_institusi');
            $table->renameColumn('kel_kod', 'kod_ruj_kelayakan');
            $table->renameColumn('pen_kod', 'kod_ruj_pengkhususan');
