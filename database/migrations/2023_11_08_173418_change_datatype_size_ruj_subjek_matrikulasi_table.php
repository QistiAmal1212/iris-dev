...
return new class extends Migration
{
    ...
    {
        Schema::table('ruj_subjek_matrikulasi', function (Blueprint $table) {
            $table->string('kod', 15)->change();
            $table->string('diskripsi', 100)->change();
            $table->string('kredit', 1)->change();
            $table->string('semester', 1)->change();
            $table->string('kategori', 15)->change();
    ...
    public function down(): void
    {
        Schema::table('ruj_subjek_matrikulasi', function (Blueprint $table) {
            ...
            $table->string('kredit', 255)->change();
            $table->string('semester', 255)->change();
