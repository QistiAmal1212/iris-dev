...
return new class extends Migration
{
    ...
    {
        Schema::table('calon_tentera_polis_sej', function (Blueprint $table) {
            $table->string('created_by')->change();
            $table->string('updated_by')->change();
            $table->renameColumn('pangkat_tentera_polis', 'pangkat_tent_polis');
            $table->renameColumn('no_tentera_polis', 'no_tent_polis');
    ...
    public function down(): void
    {
        Schema::table('calon_tentera_polis_sej', function (Blueprint $table) {
            ...
            $table->renameColumn('pangkat_tent_polis', 'pangkat_tentera_polis');
            $table->renameColumn('no_tent_polis', 'no_tentera_polis');
