...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('ruj_pengkhususan', function (Blueprint $table) {
            ...
            $table->renameColumn('type', 'jenis')->comment('Dari ruj_kod_pelbagai');
            $table->renameColumn('field', 'bidang')->comment('Dari ruj_kod_pelbagai');
    ...
    public function down(): void
    {
        ...
        Schema::table('ruj_pengkhususan', function (Blueprint $table) {
            ...
            $table->renameColumn('bidang', 'field');
