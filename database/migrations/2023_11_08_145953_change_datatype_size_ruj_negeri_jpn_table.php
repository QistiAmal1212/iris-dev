...
return new class extends Migration
{
    ...
    {
        Schema::table('ruj_negeri_jpn', function (Blueprint $table) {
            $table->string('kod_spa', 3)->change();
            $table->string('kod_jpn', 3)->change();
            $table->string('diskripsi', 30)->change();
    ...
    {
        Schema::table('ruj_negeri_jpn', function (Blueprint $table) {
            $table->string('kod_spa', 255)->change();
            $table->string('kod_jpn', 255)->change();
