...
class MaklumatPemohonController extends Controller
{
    ...
    public function searchPemohon ()
    {
        ...
        $subjekPmr = Subject::where('tkt', 3)->orderBy('diskripsi', 'asc')->get();
        $subjekSpm = Subject::where('tkt', 5)->orderBy('diskripsi', 'asc')->get();
        $subjekSpmv = Subject::where('tkt', 5)->orderBy('diskripsi', 'asc')->get();
        $subjekSvm = Subject::where('tkt', 5)->orderBy('diskripsi', 'asc')->get();
        $subjekStpm = Subject::where('tkt', 6)->orderBy('diskripsi', 'asc')->get();
        $subjekStam = Subject::where('tkt', 6)->orderBy('diskripsi', 'asc')->get();
