    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($daerah->with(['bahagian', 'negeri'])->get())
                ...
                ->editColumn('action', function ($daerah) use ($accessUpdate, $accessDelete) {
                    $button = "";
                    ...
                    if($accessUpdate){
                        ...
                        $button .= '<a href="javascript:void(0);" class="btn btn-xs btn-default" onclick="daerahForm('.$daerah->id.')"> <i class="fas fa-eye text-primary"></i> ';
                    }
                    if($accessDelete){
                        $button .= '<a href="javascript:void(0);" class="btn btn-xs btn-default" onclick="deleteItem('.$daerah->id.')"> <i class="fas fa-trash text-danger"></i> ';
                    }
                    $button .= '</div>';
