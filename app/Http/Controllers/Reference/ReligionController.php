...
class ReligionController extends Controller
{
    public function __construct()
    {
        ...
        $this->module = MasterModule::where('code', 'admin.reference.religion')->first();
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($religion)
                ...
                ->editColumn('action', function ($religion) use ($accessUpdate, $accessDelete) {
                    $button = "";
                    ...
                    if($accessUpdate){
                        ...
                        $button .= '<a href="javascript:void(0);" class="btn btn-xs btn-default" onclick="religionForm('.$religion->id.')"> <i class="fas fa-eye text-primary"></i> ';
                    }
                    if($accessDelete){
                        $button .= '<a href="javascript:void(0);" class="btn btn-xs btn-default" onclick="deleteItem('.$religion->id.')"> <i class="fas fa-trash text-danger"></i> ';
                    }
                    $button .= '</div>';
        ...
        return view('admin.reference.religion', compact('accessAdd', 'accessUpdate', 'accessDelete'));
    }
