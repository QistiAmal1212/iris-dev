    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            return Datatables::of($ahlisuruhanjaya)
                ...
                ->editColumn('action', function ($ahlisuruhanjaya) use ($accessUpdate, $accessDelete) {
                    $button = "";
                    ...
                    if($accessDelete){
                        $button .= '<a href="javascript:void(0);" class="btn btn-xs btn-default" onclick="deleteItem('.$ahlisuruhanjaya->id.')"> <i class="fas fa-trash text-danger"></i> ';
                    }
                    $button .= '</div>';
