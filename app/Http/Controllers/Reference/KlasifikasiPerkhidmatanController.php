...
class KlasifikasiPerkhidmatanController extends Controller
{
            ...
            return Datatables::of($klasifikasiperkhidmatan)
                ...
                ->editColumn('action', function ($klasifikasiperkhidmatan) use ($accessUpdate, $accessDelete) {
                    ...
                    if($accessUpdate){
                        ...
                        $button .= '<a href="javascript:void(0);" class="btn btn-xs btn-default" onclick="klasifikasiperkhidmatanForm('.$klasifikasiperkhidmatan->id.')"> <i class="fas fa-eye text-primary"></i> ';
                    }
                    if($accessDelete){
    ...
    public function deleteItem(Request $request){
        ...
        try{
            ...
            $log->description = "Hapus Klasifikasi Perkhidmatan";
            $log->data_new = json_encode($klasifikasiperkhidmatan);
            $log->url = $request->fullUrl();
            $log->method = strtoupper($request->method());
            $log->ip_address = $request->ip();
