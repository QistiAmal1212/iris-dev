    ...
    public function rules()
    {
        ...
        if ($routeName == 'pemohon.store') {
            $rules = [
                ...
                'daftar_calon.*.skim' => 'required_with:skim.*.tarikh_daftar|string|exists:ruj_skim,kod',
                ...
                'spmu_angka_giliran_1' => 'nullable|string',
                'spmu_keputusan_1' => 'nullable|string',
                'spmu_mata_pelajaran_1' => 'nullable|string',
                'spmu_tahun_1' => 'nullable|date_format:Y',
                'spmu_angka_giliran_2' => 'nullable|string',
                'spmu_keputusan_2' => 'nullable|string',
                'spmu_mata_pelajaran_2' => 'nullable|string',
                'spmu_tahun_2' => 'nullable|date_format:Y',
                ...
                'tingkatan_6_pngk' => 'nullable|array',
                'tingkatan_6_pngk.*' => 'required|array',
                'tingkatan_6_pngk.*.tahun' => 'required|date_format:Y',
                'tingkatan_6_pngk.*.pngk' => 'required|decimal:0,2',
                'svm' => 'nullable|array',
                'svm.*' => 'required|array',
