        ...
        if ($routeName == 'pemohon.store') {
            ...
            if($api->status){
                $rules = [
                    ...
                    'alamat1_tetap' => 'required|string|max:60',
                    'alamat2_tetap' => 'nullable|string|max:60',
                    'alamat3_tetap' => 'nullable|string|max:60',
                    'poskod_tetap' => 'required|string|min:5',
                    'bandar_tetap' => 'required|string|max:30',
                    'negeri_tetap' => 'required|string',
                    'alamat1_surat' => 'required|string|max:60',
                    'alamat2_surat' => 'nullable|string|max:60',
                    'alamat3_surat' => 'nullable|string|max:60',
                    'poskod_surat' => 'required|string|min:5',
                    'bandar_surat' => 'required|string|max:30',
                    ...
                    'no_daftar_rujukan_oku' => 'required_with:jenis_bantuan_oku|nullable|string|max:30',
                    ...
                    'skim.*.no_kelompok' => 'required_with:skim.*.tarikh_daftar|string|max:10',
                    'skim.*.no_siri' => 'required_with:skim.*.tarikh_daftar|string|max:3',
                    ...
                    'pengajian_tinggi.*.nama_sijil' => 'required|string|max:150',
                    ...
                    'profesional.*.no_ahli' => 'nullable|string|max:20',
                    ...
                    'bakat.*.bakat_detail' => 'nullable|string|max:5',
